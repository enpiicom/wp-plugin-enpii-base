...
* The Enpii Base plugin is now available for WordPress. After installing it, simply click on **Activate** the plugin.

* You can find out more how to install and use the plugin with our user guides documentation.

== Frequently Asked Questions ==

= What’s the difference between normal WordPress, WP App mode, and WP API mode? =

- Normal WordPress: Uses WordPress templates and query system for rendering content.
- WP App mode: Uses Laravel for handling requests and rendering with Blade templates.
- WP API mode: Similar to WP App, but for stateless API requests, without HTML rendering.

= How does Enpii Base initialize and set up the Laravel environment in WordPress? =

Enpii Base sets up the Laravel folder structure, redirects to a setup page, and uses WP CLI for configuration. It then initializes the WP_Application, registers Laravel service providers, and triggers hooks to bootstrap the Laravel environment.

= How does Enpii Base ensure Laravel doesn’t conflict with WordPress? =
...
- Clean up files and enhance code quality.

= 0.9.1 - 2025-02-11 =

- Remove unnecessary files in vendor and clean up files.

= 0.9.0 - 2025-02-10 =

- Perform WP Plugin Check.

= 0.8.9 - 2025-02-6 =

- Enhance error log for development.
- Refactor code.

= 0.8.8 - 2024-12-4 =

- Fix error when WP core is not loaded.

= 0.8.7 - 2024-11-27 =

- Refactor code and enhance requiring the Laravel helpers.
...
- Fix the error when running Enpii Base setup redirect on Frontend.
- Enhance error log for development.

= 0.8.4 - 2024-11-18 =

- Fix the error when the WordPress core is not loaded for translation function.

= 0.8.3 - 2024-11-15 =

- Improve features and performance with WordPress 6.7.
- Update PHPStan to streamline the developer workflow.
