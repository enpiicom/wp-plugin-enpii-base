...
class Register_Base_WP_App_Routes_Test extends Unit_Test_Case {
	...
	public function test_handle() {
		...
		// Create an instance of Register_Base_WP_Api_Routes
		$job = $this->getMockBuilder( Register_Base_WP_App_Routes::class )->getMock();
