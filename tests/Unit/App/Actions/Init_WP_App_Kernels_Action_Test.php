...
class Init_WP_App_Kernels_Action_Test extends Unit_Test_Case {
	...
	public function test_handle() {
		...
		$http_kernel_instance = $this->createMock( \Enpii_Base\App\Http\Kernel::class );

		// Create a mock for the Console Kernel class
		$console_kernel_instance = $this->createMock( \Enpii_Base\App\Console\Kernel::class );

		// Create a mock for the Exception Handler class
		$exception_handler_instance = $this->createMock( \Enpii_Base\App\Exceptions\Handler::class );
