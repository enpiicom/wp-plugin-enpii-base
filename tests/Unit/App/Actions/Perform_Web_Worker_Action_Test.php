...
use Enpii_Base\Tests\Unit\App\Actions\Perform_Web_Worker_Action_Test\Perform_Web_Worker_Action_Test_Queue_Tmp;
use Mockery;
use WP_Mock;
...
class Perform_Web_Worker_Action_Test extends Unit_Test_Case {
	...
	public function test_handle_does_not_call_artisan_when_web_worker_is_disabled() {
		// Arrange: Mock Enpii_Base_Helper::disable_web_worker to return true
	...
	public function test_handle() {
		...
		// Arrange: Mock Enpii_Base_Helper::disable_web_worker to return false
		$helper_mock = Mockery::mock( 'alias:Enpii_Base\App\Support\Enpii_Base_Helper' );
		$helper_mock->shouldReceive( 'disable_web_worker' )
			->once()
			->andReturn( false );
...
namespace Enpii_Base\Tests\Unit\App\Actions\Perform_Web_Worker_Action_Test;
