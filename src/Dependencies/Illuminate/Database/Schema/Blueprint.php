...
use Enpii\Wp_Plugin\Enpii_Base\Dependencies\Illuminate\Database\Query\Expression;
use Enpii\Wp_Plugin\Enpii_Base\Dependencies\Illuminate\Database\Schema\Grammars\Grammar;
use Enpii\Wp_Plugin\Enpii_Base\Dependencies\Illuminate\Database\SQLiteConnection;
...
class Blueprint
{
     ...
     *
     * @var \Enpii\Wp_Plugin\Enpii_Base\Dependencies\Illuminate\Database\Schema\ColumnDefinition[]
     */
    protected $columns = [];
     ...
     *
     * @var \Enpii\Wp_Plugin\Enpii_Base\Dependencies\Illuminate\Support\Fluent[]
     */
    protected $commands = [];
     ...
     *
     * @return \Enpii\Wp_Plugin\Enpii_Base\Dependencies\Illuminate\Support\Fluent
     */
     ...
     * @param  string|array  $columns
     * @param  string|null  $name
     * @return \Enpii\Wp_Plugin\Enpii_Base\Dependencies\Illuminate\Database\Schema\ForeignKeyDefinition
     */
     ...
     *
     * @param  string  $column
     * @return \Enpii\Wp_Plugin\Enpii_Base\Dependencies\Illuminate\Database\Schema\ColumnDefinition
     */
     ...
     *
     * @param  string  $column
     * @return \Enpii\Wp_Plugin\Enpii_Base\Dependencies\Illuminate\Database\Schema\ForeignIdColumnDefinition
     */
