...
class ResetPassword extends Notification
{
    ...
    public function toMail($notifiable)
    {
        ...
        if (static::$createUrlCallback) {
            ...
            $url = url(wp_app_route('password.reset', [
                'token' => $this->token,
        ...
        return (new MailMessage)
            ...
            ->line(Lang::get('This password reset link will expire in :count minutes.', ['count' => wp_app_config('auth.passwords.'.wp_app_config('auth.defaults.passwords').'.expire')]))
