...
trait Converter
{
     ...
     *             You should rather let Enpii\Wp_Plugin\Enpii_Base\Dependencies\Carbon object being casted to string with DEFAULT_TO_STRING_FORMAT, and
     ...
     * @example
     * ```
     * echo Carbon::now(); // Enpii\Wp_Plugin\Enpii_Base\Dependencies\Carbon instances can be casted to string
     * ```
     *
     * @return string
     */
